...
CXXFLAGS = -Wall -g -pipe -O3 `pkg-config opencv --cflags` -I./include #$(VECTFLAGS) -I/usr/include/arm-linux-gnueabihf # -fvariable-expansion-in-unroller  #-fgcse-las #-funsafe-loop-optimizations -Wunsafe-loop-optimizations -fno-inline-functions 
